...
WIFI_DBM=$(iwconfig wlan1 | grep 'Signal level' | awk -F '=' '{print $3}' | awk '{print $1}')
...
NET_TRAFFIC_RX=$(ip -s link show wlan1 | awk '/^\s*RX:/{getline; print $1}')
NET_TRAFFIC_TX=$(ip -s link show wlan1 | awk '/^\s*TX:/{getline; print $1}')
